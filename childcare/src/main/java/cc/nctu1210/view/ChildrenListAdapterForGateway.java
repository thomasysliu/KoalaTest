...
public class ChildrenListAdapterForGateway extends BaseAdapter {
    private final static String TAG = ChildrenListAdapterForGateway.class.getSimpleName();
    /**
     ...
     * @param mData
     */
    public ChildrenListAdapterForGateway(final Context context, final List<ChildItem> mData) {
        this.mData = mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.rssi_status      = (TextView) view.findViewById(R.id.text_child_status);
        ...
        if (mData != null) {
            ...
            viewHolder.rssi_status.setText(obj.rssi);
